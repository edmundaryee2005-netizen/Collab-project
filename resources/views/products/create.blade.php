...
@section('title', 'Upload New Product')
                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">₵</span>
                                <input type="text" name="market_price_range" id="market_price_range" class="form-control @error('market_price_range') is-invalid @enderror" value="{{ old('market_price_range') }}" placeholder="e.g. 90K - 95K">
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <!-- Pre-fill with user's profile phone as a default -->
                            <input type="tel" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', auth()->user()->phone) }}" placeholder="e.g. 233551234567">
                        </div>
                        <div class="form-text">
                            Enter the number you want buyers to contact for this product. Defaults to your profile phone.
                        </div>
                        @error('phone')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" name="negotiable" value="1" class="form-check-input" id="negotiable" {{ old('negotiable') ? 'checked' : '' }}>
